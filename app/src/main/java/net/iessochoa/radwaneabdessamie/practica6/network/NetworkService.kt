package net.iessochoa.radwaneabdessamie.practica6.network
...
object NetworkService {
    ...
    private val listaPersonajes: MutableList<Personaje> = mutableListOf()
    //livedata que observaremos en la vista
    private val personajesLiveData = MutableLiveData(listaPersonajes)
    //página que estamos leyendo actualmente. Iremos trayendo nuevas páginas según necesitemos
    //y las añadiremos a la lista
    //recuerda el formato https://rickandmortyapi.com/api/character?page=2
    ...
    /**
     * Este método se conectará al servicio y pedirá las siguientes página de la
    colección de
...
//actualizamos el LiveData
     ...
     */
    fun getLiveDataListaPersonajes (): LiveData<MutableList<Personaje>> {
        return personajesLiveData
    }
    /**
     * Función genérica que permite saber si tenemos conexión a internet
     */
